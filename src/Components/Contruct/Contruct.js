...
const Contruct = () => {
  ...
  const onSubmit = (data) => {
    fetch(`https://interior-design-seven-psi.vercel.app/contract_box`, {
      method: "POST", // or 'PUT'
      headers: {
  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px] m-3">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className=" hover:from-teal-600  w-full p-3 text-white transition border rounded border-primary bg-primary hover:bg-opacity-90">
                      Send Message
                    </button>
                  </div>
                </form>
